			...
			<div class="row">
				...
				<div class="row col-6 border-right pr-0">
					...
					<?php if (isset($_GET['status'])) { ?>
						<div class="alert alert-warning alert-dismissible fade show center-block bg-success bg-gradient text-white" role="alert">
					...
					<div class="p-5 py-5">
						...
						<div class="row mt-2 border-top">
							...
							<div class="mt-3 col-md-6"><label class="labels" style="font-size: 17px;">Full Name</label>
								<input type="text" name="fullname" placeholder="Enter your fullname" class="form-control" value="<?php echo $fullname; ?>">
							</div>
							...
							<div class="mt-2 col-md-6"><label class="labels" style="font-size: 17px;">Email Address</label>
								<input type="text" name="emails" placeholder="Enter your email address" class="form-control" value="<?php echo $email; ?>">
							</div>

							<div class="mt-2 col-md-6"><label class="labels" style="font-size: 17px;">Mobile Number</label>
								<input type="text" name="number" placeholder="Enter your mobile number" class="form-control" value="<?php echo $phonenumber; ?>">
							</div>
							...
							<div class="mt-2 col-md-6"><label class="labels" style="font-size: 17px;">Date of Birth</label>
								<input type="date" name="datebirth" class="form-control" value="<?php echo $dateofbirth; ?>">
							</div>
