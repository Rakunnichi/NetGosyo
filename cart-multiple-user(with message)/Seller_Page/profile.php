          ...
          <div class="row">
            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  <p class="text-sm">
                    Hi, I’m Earl, If you`re looking for an affordable clothings with high quality, then look no more because that is what we Offer!
                  </p>
                  ...
                  <ul class="list-group">
                    ...
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Address:</strong> &nbsp; <?php echo $address; ?></li>
