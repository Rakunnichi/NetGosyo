        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <?php if($user_id == 3){
                  ?>
              <div class="col">
                <a href="checkout.php"><button type="submit" class="btn btn-danger form-control" disabled>Checkout</button></a>
              </div>
              <?php
                    }else{
                        ?>
              <div class="col">
                <a href="checkout.php"><button type="submit" class="btn btn-danger form-control">Checkout</button></a>
              </div>
              <?php
                    }
                    ?> 
              ...
              <div class="col">
                <form action="" class="form-submit" method="POST">
                  ...
                  <button type="submit" name="add_to_cart" class="btn btn-warning form-control addItemBtn">Add to Cart</button>
                </form>
              </div>
            </div>
          </div>
          <div class="col-sm-6 py-5">
            ...
            <div id="order-details" class="font-rale d-flex flex-column text-dark">
              <small><i class="fas fa-calendar color-primary mr-1" style="width:16px"></i> Delivery by : Jun 23 - Jun 28</small>
              <small><i class="fas fa-check color-primary mr-1" style="width:16px"></i> Sold by <a href="javascript:">NetGosyo </a></small>
              <small><i class="fas fa-map-marker-alt color-primary mr-1" style="width:16px"></i> Deliver to Customer - <?= $name ?></small>
            </div>
            <!-- !Order Details -->
