                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">Seller_Id</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">  
                          ...
                          <p class="text-xs font-weight-bold mb-0"><?php echo $fetch_product['id'];?></p>
                          </div>
                        </div>
                      </td>

                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $fetch_product['user_id'];?></p>
                      </td>

                      <td>
                        <span class="text-xs font-weight-bold"><?php echo $fetch_product['name'];?></span>
                      </td>

                      <td>
                        <span class="text-xs font-weight-bold">₱ <?php echo $fetch_product['price'];?>.00</span>
                      </td>

                      <td>
                        <span class="text-xs font-weight-bold"><?php echo $fetch_product['item_brand'];?></span>
                      </td>
